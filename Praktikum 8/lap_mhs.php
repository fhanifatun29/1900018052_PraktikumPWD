<?php
    ...
    while ($row = mysqli_fetch_array($mahasiswa)){ 
         ...
         $pdf->Cell(25,6,$row['jkel'],1,0); //untuk menampilkan jkel mahasiswa dan memberikan space agar tidak terlalu rapat
         $pdf->Cell(50,6,$row['alamat'],1,0); //untuk menampilkan alamat mahasiswa dan memberikan space agar tidak terlalu rapat
         $pdf->Cell(30,6,$row['tgl_lahir'],1,1); //untuk menampilkan tanggal lahir mahasiswa dan memberikan space agar tidak terlalu rapat
        }
